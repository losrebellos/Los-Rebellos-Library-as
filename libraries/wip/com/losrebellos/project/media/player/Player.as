package com.losrebellos.project.media.player 
{
	...
	public class Player extends SpritePlus implements IPlayer 
	{
		...
		{
			_stream = stream;
			_stream.addEventListener(StreamEvent.STREAM_INITIALIZED, onStreamInitialized);
		...
		// INIT
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		protected function onStreamInitialized(e:StreamEvent):void
		{
			_stream.removeEventListener(StreamEvent.STREAM_INITIALIZED, onStreamInitialized);
